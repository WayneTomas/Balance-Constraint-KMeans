...
clusterMSE_S=[];
clusterTime_S=[];
clusterCountSum_S=zeros(5,5);
clusterMSESum_S=zeros(5,5);
clusterTimeSum_S=zeros(5,5);
...
clusterMSE_Me=[];
clusterTime_Me=[];
clusterCountSum_Me=zeros(5,5);
clusterMSESum_Me=zeros(5,5);
clusterTimeSum_Me=zeros(5,5);
...
clusterMSE_Kbs=[];
clusterTime_Kbs=[];
clusterMSESum_Kbs=zeros(5,5);
clusterTimeSum_Kbs=zeros(5,5);
